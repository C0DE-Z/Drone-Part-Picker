          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/C0DE-Z/Drone-Part-Picker" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  GitHub
                </a>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/parts/custom" className="text-gray-400 hover:text-white transition-colors">
                    Custom Parts
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="mailto:support@dronepartpicker.com" className="text-gray-400 hover:text-white transition-colors">
                    Contact Support
                  </a>
                </li>
              </ul>
