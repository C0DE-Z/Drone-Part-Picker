...
export default function AdvancedSettingsComponent({
    ...
    return (
      <div className="flex flex-col space-y-1">
        ...
        <input
          ...
          max={max}
          step={step}
          className="w-full px-2 py-2 sm:px-3 sm:py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm sm:text-base bg-white text-gray-900"
        />
      </div>
    );
  };
  ...
  if (!isOpen) {
    return (
      <button
        onClick={onToggle}
        className="fixed bottom-4 left-4 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 sm:px-4 sm:py-2 rounded-lg shadow-lg transition-colors duration-200 flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base z-40"
      >
        <span>⚙️</span>
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-xs bg-black/60 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white border border-gray-200 rounded-lg shadow-xl w-full max-w-4xl h-full max-h-[95vh] sm:max-h-[90vh] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 bg-white">
          <h2 className="text-lg sm:text-2xl font-bold text-gray-900">Advanced Settings</h2>
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              onClick={resetToDefaults}
              className="px-2 py-1 sm:px-4 sm:py-2 text-xs sm:text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md transition-colors"
            >
        ...
        <div className="flex-1 p-4 sm:p-6 overflow-y-auto">
          {activeTab === 'environment' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Environmental Conditions</h3>
          ...
          {activeTab === 'battery' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Battery Configuration</h3>
              ...
              <h4 className="text-sm sm:text-md font-medium text-gray-800">Temperature Efficiency</h4>
          ...
          {activeTab === 'motor' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Motor Configuration</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          {activeTab === 'propeller' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Propeller Configuration</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          {activeTab === 'flight' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Flight Style Factors</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          {activeTab === 'system' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">System Efficiency</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          {activeTab === 'limits' && (
            <div className="space-y-4 sm:space-y-6">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900">Realistic Limits</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
